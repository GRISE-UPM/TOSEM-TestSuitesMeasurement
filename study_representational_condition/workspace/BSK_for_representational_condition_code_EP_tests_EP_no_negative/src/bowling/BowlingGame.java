...
public class BowlingGame {
	...
	private BonusFrame bonus;

	public BowlingGame(){}

	public void addFrame(Frame frame) throws InvalidInput, BowlingException{
	...
	public void setBonus(int firstThrow, int secondThrow) throws BowlingException {
		if(findBonus()) {
			if(firstThrow < 0 || secondThrow < 0 || firstThrow > 10 || secondThrow > 10)
				throw new BowlingException();
			else {
				if(frames.get(9).isStrike())
					bonus = new BonusFrame(firstThrow, secondThrow);
				else 
					if(secondThrow != 0)
						throw new BowlingException();
					else
